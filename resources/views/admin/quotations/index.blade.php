...
@endsection
@section('content')
<div x-data="quotationsList()" class="space-y-6">
    ...
    Alpine.data('quotationsList', () => ({
        ...
        async fetchData() {
            ...
            try {
                ...
                if (!res.ok) throw new Error((await res.json()).message || 'Failed to load quotations');
                ...
                if (seq === this.requestSeq) this.showToast('error', e.message || 'Could not load quotations.');
            } finally {
